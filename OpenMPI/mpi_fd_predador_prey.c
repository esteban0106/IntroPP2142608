...
# include <string.h>
# include <time.h>
# include <mpi.h>           // se incluyo la libreria de mpi para poder paralelizar el codigo
...
/*
 ...
 Purpose:
	...
	MODIFY the original code fd_predador_prey.c in such a way that it works in parallel and can improve its predormance
 ...
 Author:
	...
	Inducción a la programación paralela I,
	esteban.nino@correo.uis.edu.co
...
MPI_Comm_rank(MPI_COMM_WORLD,&numprocxnodo);
